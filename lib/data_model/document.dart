...
class DocumentRow {
  ...
  DocumentRow({required this.numeroDocument, required this.numeroLigne, this.article, this.qte, this.remisePrct});
...
class Document {
  ...
  Document({required this.docType, required this.numeroDocument, required this.client, required this.lignes});
